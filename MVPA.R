...
ExeLigScore_NT2 <- ordered(data$ExeLigDuLY.NT2BLQ1, c("Ingen", "Under 1 time", "1-2 timer", "3 timer eller mer"))
...
ExeHarScore_NT2 <- ordered(data$ExeHarDuLY.NT2BLQ1, c("Ingen", "Under 1 time", "1-2 timer", "3 timer eller mer"))
