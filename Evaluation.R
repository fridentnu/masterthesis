...
full.gamma.var <- predict(full.pred.mod.gamma, se.fit = T, dispersion=summary(full.pred.mod.gamma)$dispersion)$se.fit**2 + predict(full.pred.mod.gamma, se.fit = T, dispersion=summary(full.pred.mod.gamma)$dispersion)$residual.scale**2
